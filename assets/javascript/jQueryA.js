					   ...
					   {
						   {
							   output+="<h2><li>" + "£" + data.properties[i].price +"</li></h2>" +
							    ...
							    + "<button><a href='" + data.properties[i].url + "'>Visit Page</a></button>";
					/*	output+="<tbody><tr><td>" + "<img src=" + data.properties[i].picture + ">"+"</td>"
						+"<td><div><table><tbody><tr><td>Price</td><td>"+ "£" + data.properties[i].price +"</td></tr>"
						+"<tr><td>Screen</td><td>5.8 inches</td></tr>"
						+"<tr><td colspan='2'><button><a href='" + data.properties[i].url +
						"'>Visit Page</a></button></td></tr></tbody></table></div></td></tbody>" 
						;*/ 
					} } } } }
			//	output+="</ul>";
			output+="</table>";
